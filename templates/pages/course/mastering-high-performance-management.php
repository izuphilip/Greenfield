<div class="inner-banner">
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-4 col-lg-3"> <a href="apply-online.html" class="apply-online clearfix">
                        <div class="left clearfix"> <span class="icon"><img src="<?=$assets?>/images/apply-online-sm-ico.png" class="img-responsive" alt=""></span> <span class="txt">Apply Online</span> </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-5">
                    ...
                    <div class="btn-wrapper clearfix"> <a href="#" class="download-pros"> <span class="ico-block"><img src="<?=$assets?>/images/download-prospects-ico2.png" alt="download prospects"></span> <span class="txt-block"> <span class="sm-txt">Download</span> Prospects </span> </a> <a href="#" class="download-cert"> <span class="ico-block"><img src="<?=$assets?>/images/certification-sm-ico.png" alt="certification"></span> <span class="txt-block"> <span class="sm-txt">Download</span> Certification </span> </a> </div>
                </div>
                <div class="col-md-7 left-block">
                    <h2>Online skilled Courses</h2>
    ...
    ** Browse Teacher **
    ...
    <section class="browse-teacher padding-lg">
        <div class="container">
            <h2><span>There are many ways to learn</span> BROWSE BY TEACHER</h2>
            <ul class="row browse-teachers-list clearfix">
                <li class="col-xs-6 col-sm-3">
                    <figure> <img src="<?=$assets?>/images/teacher1.jpg" width="124" height="124" alt=""> </figure>
                ...
                <li class="col-xs-6 col-sm-3">
                    <figure> <img src="<?=$assets?>/images/teacher2.jpg" width="123" height="124" alt=""> </figure>
                    <h3>Bruno Acselrad</h3>
                ...
                <li class="col-xs-6 col-sm-3">
                    <figure> <img src="<?=$assets?>/images/teacher3.jpg" width="123" height="124" alt=""> </figure>
                    <h3>Bruno Acselrad</h3>
                ...
                <li class="col-xs-6 col-sm-3">
                    <figure> <img src="<?=$assets?>/images/teacher4.jpg" width="123" height="124" alt=""> </figure>
                    <h3>Bruno Acselrad</h3>
    ...
    <section class="testimonial padding-lg">
        <div class="container">
            <div class="wrapper">
                ...
                <div id="bx-pager"> <a data-slide-index="0" href=""><img src="<?=$assets?>/images/testimonial-thumb1.jpg" class="img-circle" alt=""></a> <a data-slide-index="1" href=""><img src="<?=$assets?>/images/testimonial-thumb2.jpg" class="img-circle" alt=""></a> <a data-slide-index="2" href=""><img src="<?=$assets?>/images/testimonial-thumb3.jpg" class="img-circle" alt=""></a> </div>
            </div>
        </div>
    </section>
