            ...
            <div class="col-sm-8 blog-left">
                <ul class="blog-listing">
                    <li> <img src="images/blog-img1.jpg" class="img-responsive" alt="">
                        ...
                        <a href="blog-detail.html" class="read-more"><span class="icon-play-icon"></span>Read More</a>
                    </li>
                    <li> <img src="images/blog-img2.jpg" class="img-responsive" alt="">
                        <h2>Lorem Ipsum is simply dummy text of the printing and typesetting industry.</h2>
                        <ul class="post-detail">
                            <li><span class="icon-date-icon ico"></span><span class="bold">14 Feb</span> 2017</li>
                            <li>Posted By : <span class="bold">Julien Renvoye</span></li>
                    ...
                    <li> <img src="images/blog-img3.jpg" class="img-responsive" alt="">
                        <h2>Lorem Ipsum is simply dummy text of the printing and typesetting industry.</h2>
                        <ul class="post-detail">
                            <li><span class="icon-date-icon ico"></span><span class="bold">14 Feb</span> 2017</li>
                            <li>Posted By : <span class="bold">Julien Renvoye</span></li>
                    ...
                    <li> <img src="images/blog-img4.jpg" class="img-responsive" alt="">
                        <h2>Lorem Ipsum is simply dummy text of the printing and typesetting industry.</h2>
                        <ul class="post-detail">
                            <li><span class="icon-date-icon ico"></span><span class="bold">14 Feb</span> 2017</li>
                            <li>Posted By : <span class="bold">Julien Renvoye</span></li>
